                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample" style="">
                              <div class="card-body">
                                ...
                                <form>
                                    ...
                                    <p><input type="tel" value="تم انشاء الاوردر بتاريخ : {{$item -> created_at}}" required id="phone" name="phone" placeholder="Phone"></p>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="table-body-row">
                                                            <td class="product-remove">
                                                                <a href="/deletecartitem/{{$detail->id}}"><i class="far fa-window-close"></i></a>
                                                            </td>
                                                            <td class="product-image"><img src="{{ asset('storage/' . $detail->product->image) }}"
                                                                    alt=""></td>
                                                            ...
                                                            <td class="product-total">
                                                                {{ $detail->product->price * $detail->quantity }} $</td>
